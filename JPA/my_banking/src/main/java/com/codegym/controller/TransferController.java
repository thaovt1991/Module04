...
public class TransferController {
    ...
    private ModelAndView saveDeposits(@ModelAttribute("transfer") Transfer transfer){
        ...
        transfer.setFeesAmount(transaction_amount);
        ...
        long totalMoneyTrasfer = transfer.getTransferAmount()+transfer.getFeesAmount() ;
        ...
        customer_sender.setBalance(customer_sender.getBalance() - transfer.getFeesAmount() -transfer.getTransferAmount());
    ...
    public ModelAndView showListTransfers(){
        ModelAndView modelAndView = new ModelAndView("/customer/transfer_his") ;

//        List<TransferDTO> transfers = transferService.findAllTransferDTO();

        List<ITransferDTO> transfers = transferService.findAllITransferDTO();
